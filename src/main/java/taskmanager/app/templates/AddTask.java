...
public class AddTask extends javax.swing.JFrame {
    ...
    public AddTask(User user, HomePage homePage, int selectedTaskId) {
        ...
        this.task = user.getOwnTasks().get(selectedTaskId);
        initComponents();
        loadTask();
    }
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 629,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(addBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 91,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(50, 50, 50)
                                                .addComponent(importBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 94,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(50, 50, 50))
                                        .addComponent(deadlinePicker, javax.swing.GroupLayout.PREFERRED_SIZE, 353,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(deadLineLbl)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(deadlinePicker, javax.swing.GroupLayout.PREFERRED_SIZE, 250,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_addBtnActionPerformed
        ...
        if (selectedTaskId != -1) {
            try {
                ...
                TaskController.writeTxtFile(task, user, oldFileName);
                this.dispose();
                return;
    ...
    private void loadTask() {
        ...
        oldFileName = task.getTitle();
        titleTxtArea.setText(task.getTitle());
        contentTxtArea.setText(task.getDescription());
        addBtn.setText("Update");
    }

    // public void writeTxtFile(Task task) {

    //     String destination = "C:/Users/jayng/Desktop/Education/study/College/Java Programming/Assignments/taskmanager/src/main/java/taskmanager/app/resources"
    ...
    //             writer.write(sdf.format(deadlinePicker.getDate()));
    //             writer.write("\n");
    //             // if (selectedTaskId != -1) {
    ...
    //             writer.write("\n");
    //             // }
    //             writer.write(titleTxtArea.getText());
    //             writer.write("\n");
    //             writer.write(contentTxtArea.getText());
